...
function move() {
    ...
    // 3) Змейка не попала на преграду
    //console.log(new_unit);
    if (!isSnakeUnit(new_unit) && new_unit !== undefined && !snake_head_classes.includes("bomb-unit")) {
...
function deleteBomb() {
    bomb.pop().classList.remove('bomb-unit');
}
